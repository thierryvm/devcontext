...
@{
    ...
    # --- ctx dashboard ------------------------------------------------------
    'dash.titre'              = 'DevContext -- the state of this machine'
    'dash.entete.dossier'     = 'Folder {0}, governed by the {1} context.'
    ...
    'dash.diag.vide'          = 'Nothing reported. From a context folder: ctx doctor'
    'dash.ctx.titre'          = 'Contexts and accounts'
    'dash.ctx.vide'           = 'No context declared on this machine. For the guided setup: ctx init'
    'dash.editeur.titre'      = 'Editors'
    'dash.editeur.vide'       = 'No editor found. To see what is looked for, and where: ctx editors'
    ...
    'dash.col.domaine'        = 'Domain'
    'dash.col.sujet'          = 'Subject'
    'dash.col.verdict'        = 'Verdict'
    'dash.col.detail'         = 'Detail'
    'dash.col.correctif'      = 'Fix'
    'dash.col.contexte'       = 'Context'
    'dash.col.racine'         = 'Root'
    'dash.col.compte'         = 'Account'
    'dash.col.editeur'        = 'Editor'
